...
Use write_email_draft to draft your reply. Always pass the original thread_id so the draft becomes a real reply, not a new thread. When the draft is created, call Done with a one-line summary."""